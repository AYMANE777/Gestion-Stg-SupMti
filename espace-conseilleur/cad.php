			...
			<div class="card card-flush h-lg-100">
				<div class="card-header mt-6">
                    ...
                    <div class="card-toolbar m-0">
                        <a style="margin-top: 10px;" class="btn btn-flex h-40px btn-primary" data-bs-toggle="modal" data-bs-target="#add_stagiaire">Ajouter un stagiaire</a>
					</div>
				</div>
                    ...
                    <?php
                        ...
                        if($TotalCAD > 0)
                        {
                            while($st = mysqli_fetch_assoc($QueryCAD))
                            {
                                ...
                                <a href="#" onclick="removeStagiaireCAD('.$st['id'].')" style="float: right;" class="btn btn-icon btn-light-primary btn-sm ">
...
<div class="modal fade" tabindex="-1" id="add_stagiaire">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Ajouter un stagiaire au C.A.D</h5>
            ...
            <div class="modal-body">
                ...
                <div class="fv-row mb-10">
                    <label class="form-label fs-6 fw-bolder text-dark">Fonction:</label>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="addStagiaireCAD">Ajouter</button>
            </div>
        </div>
    </div>
</div>
