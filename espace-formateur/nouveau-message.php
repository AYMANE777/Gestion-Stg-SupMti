						...
						<form id="kt_inbox_compose_form">
							...
							<div class="d-block">
								...
								<div class="d-flex align-items-center border-bottom px-8 min-h-50px">
									...
									<!--end::Label-->
									<!--begin::Input-->
									<input type="text" id="searchFormateur" class="form-control form-control-transparent border-0" maxlength="1" name="compose_to" value="" data-kt-inbox-form="tagify" />
									<!--end::Input-->
								</div>
								<!--end::BCC-->
								<!--begin::Subject-->
...
<input type="hidden" id="newMessage" value="formateur-message">
<?php
